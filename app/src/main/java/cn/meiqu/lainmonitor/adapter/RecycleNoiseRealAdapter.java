...
public class RecycleNoiseRealAdapter extends BaseRecycleAdapter {
    private Context mContent;
    private ArrayList<Noise> thunders;

    public RecycleNoiseRealAdapter(Context mContent, ArrayList<Noise> thunders) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new Holder(View.inflate(mContent, R.layout.recycle_noise_real, null));
    }
    ...
    class Holder extends BaseHolder implements RippleView.OnRippleCompleteListener {
        ...
        public void instanceView(final int position) {
            Noise water = thunders.get(position);
            mTvName.setText(water.getDevicename() + "");
            tv_temp.setText(water.getNoise() + "");
