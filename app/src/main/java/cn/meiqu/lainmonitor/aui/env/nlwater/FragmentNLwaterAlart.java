...
public class FragmentNLwaterAlart extends FragmentAlert implements BaseOnRecycleClickListener {
    ...
    public RecyclerView.Adapter getAdapter() {
        ...
        adapter.setHeaderView(LayoutInflater.from(getActivity()).inflate(R.layout.recycle_wateralart_type2,null));
        return adapter;
    }

    @Override
    public View getTopView() {
        return LayoutInflater.from(getActivity()).inflate(R.layout.recycle_wateralart_type3, null);
    }
